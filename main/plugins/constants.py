...
SINGLE_COURSE_URL = "https://{portal_name}.udemy.com/api-2.0/users/me/subscribed-courses/{course_id}/lectures/{lecture_id}/?fields[lecture]=asset,description,download_url,is_free,last_watched_second&fields[asset]=asset_type,length,media_license_token,course_is_drmed,media_sources,captions,thumbnail_sprite,slides,slide_urls,download_urls,external_url"
...
WVD_FILE_PATH = os.path.join(os.getcwd(), "samsung_sm-a310f_v4.0.0-android_e100205a_4445_l3.wvd")
CACHE_KEY_FILE_PATH = os.path.join(os.getcwd(), "cached_keys.json")
MP4DECRYPT_PATH = os.path.join(os.getcwd(), "bin/mp4decrypt")
